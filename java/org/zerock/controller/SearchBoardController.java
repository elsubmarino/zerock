...
public class SearchBoardController {
	...
	public void listPage(@ModelAttribute("cri") SearchCriteria cri, Model model) throws Exception {
		...
		//pageMaker.setTotalCount(service.list4CountCriteria(cri));
	...
	public void real(@RequestParam("bno") int bno,@ModelAttribute("cri") SearchCriteria cri,Model model) throws Exception{
